...
-- ================================================================
-- Step 0: Drop Existing Constraints
-- ================================================================

-- ALTER TABLE OrderDetails DROP CONSTRAINT FK_OrderDetails_FactOrders;
-- ALTER TABLE OrderDetails DROP CONSTRAINT FK_OrderDetails_DimProducts;
-- ALTER TABLE FactOrders DROP CONSTRAINT FK_FactOrders_DimCustomers;
-- ALTER TABLE FactOrders DROP CONSTRAINT FK_FactOrders_DimEmployees;
-- ALTER TABLE FactOrders DROP CONSTRAINT FK_FactOrders_DimShippers;
-- ALTER TABLE FactOrders DROP CONSTRAINT FK_FactOrders_DimTerritories;
-- ALTER TABLE DimProducts DROP CONSTRAINT FK_DimProducts_DimSuppliers;
-- ALTER TABLE DimProducts DROP CONSTRAINT FK_DimProducts_DimCategories;
-- ALTER TABLE DimTerritories DROP CONSTRAINT FK_DimTerritories_DimRegion;
-- ALTER TABLE DimEmployees DROP CONSTRAINT FK_DimEmployees_ReportsTo;
